...
$sqlUserId = "SELECT id FROM usuarios";
$resultUserId = $conexion->query($sqlUserId);
$ids = $resultUserId->fetch_assoc();
$firstUserId = $ids['id'] ?? null;
...
if ($Comprobante !== null && $Tipo_Comprobante !== null && $Numero !== null && $Fecha !== null && $Id_Contribuyente !== null && $Neto_21 !== null && $Neto_10_5 !== null && $Neto_27 !== null && $Iva_21 !== null && $Iva_10_5 !== null && $Iva_27 !== null && $Exento !== null && $No_Gravado !== null && $Impuestos !== null && $Percepciones !== null && $Retenciones !== null && $Gastos !== null && $Total !== null && $Periodo !== null && $Signo !== null && $id_usuario !== null) {
    ...
    if ($stmt) {
        $stmt->bind_param("ssssdddddssssssssssss", $Comprobante, $Tipo_Comprobante, $Numero, $Fecha, $Id_Contribuyente, $Neto_21, $Neto_10_5, $Neto_27, $Iva_21, $Iva_10_5, $Iva_27, $Exento, $No_Gravado, $Impuestos, $Percepciones, $Retenciones, $Gastos, $Total, $Periodo, $Signo, $firstUserId);
...
<body>
    <div class="dashboard">
        ...
        <div class="content">
            ...
            <form action="FacturasVentas.php" method="post">
                <label for="Comprobante">Comprobante:</label>
                <input type="text" name="Comprobante" id="Comprobante" pattern="^([A-Z]{2})$" placeholder="Ejemplo: FC, RC, ND, NC" required><br>
                ...
                <input type="number" name="Signo" id="Signo" pattern="^(1|-1)$" placeholder="Ejemplo: 1 |-1" required><br>

                <label for="id_usuario">ID de Usuario:</label>
                <input type="number" name="id_usuario" id="id_usuario" value='<?php echo $ids; ?>' placeholder="Ejemplo: 1" required><br>
